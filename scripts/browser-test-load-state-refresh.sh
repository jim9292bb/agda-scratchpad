...
assert_selector_count ".goal-card" 1 "Initial Load creates one goal card"
...
assert_goals_empty
assert_selector_count ".goal-card" 0 "Failed Load clears old goal card"
...
assert_selector_count ".goal-card" 0 "Warning fixture has no goals"
...
assert_selector_count ".goal-card" 1 "Final Load recreates goal card"
assert_selector_count ".agda-hole[data-goal-id]" 1 "Final Load recreates goal marker"
assert_active_goal_contains "Goal 0" "Final Load active goal id"
assert_active_goal_contains "N" "Final Load active goal details"
