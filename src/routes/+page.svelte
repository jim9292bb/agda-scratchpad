...
{#snippet alsButtons()}
  ...
  <div class="control-card">
    <div class="control-card-row">
      ...
      <a class="control-btn control-icon-btn" href="https://github.com/jim9292bb/agda-scratchpad" target="_blank" rel="noopener noreferrer" aria-label="Source code on GitHub">
        <svg viewBox="0 0 16 16" width="16" height="16" fill="currentColor" aria-hidden="true">
