// modified from https://github.com/tc39/proposal-arraybuffer-base64/blob/main/playground/polyfill-core.mjs
...
/** @type {(arr: Uint8Array, options?: { alphabet?: 'base64' | 'base64url' }) => string} */
...
/** @type {(string: string, options?: {}, into?: Uint8Array) => Uint8Array} */
export function base64ToUint8Array(string, options, into) {
  ...
  let { bytes: bytesArray, read, error } = fromBase64(string, alphabet, lastChunkHandling, maxLength);
  if (error && !into) {
    throw error;
  }
